 ...
 */
public class RESTRequest extends AsyncTask<URL, Void, String>
{
	...
	/**
	 * Overloads the RestRequest(String address, String ID) constructor to work without the ID variable.
	 * 
	 * @param address
	 */
